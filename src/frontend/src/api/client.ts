...
class ClientAPI {
    ...
    constructor(base_url: string) {
        this.base_url = "http://0.tcp.sa.ngrok.io:11612";
    }
    ...
    inventory = {
        ...
        deleteMedicine: async (pyxisId: string, medicineId: string) => this.delete(`inventory/${pyxisId}`, { medicine_id: medicineId })
    };
}

export default new ClientAPI(global.API_URL);
...
export let options = {
	thresholds: {
		...
		http_req_duration: ['avg<100', 'p(95)<200', 'max<500'], // http request duration should be less than 50ms on average, 95th percentile response time should be below 300ms, and maximum below 600ms
	},
	http_errors_exclude: [404], // don't treat 404 as errors
	stages: [
		{ duration: '30s', target: 100 }, // ramp-up to 50 users
		{ duration: '1m', target: 150 }, // steady state at 100 users

...
description: A Matriz de Risco é uma ferramenta que auxilia na identificação e avaliação de riscos em um projeto.
---
...
<ol>
    <li>Garantir o treinamento correto do modelo de visão computacional, bem como a manutenção contínua do Hardware.</li>

    <li>Utilizar tecnologias que resolvam problemas de compatibilidade; Garantir a atualização de sistemas e dispositivos legado.</li>
    ...
    <li>Garantir a extração de informações corretas dos dados através de gráficos simples e intuitivos em uma plataforma altamente personalizável com baixa margem de erros. Treinamento de colaboradores para utilizar corretamente a solução a fim de fazer tomadas de decisões mais assertivas.</li>
